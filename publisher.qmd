...
In den heute vorliegenden Publikationsjobs werden häufig die Daten vom relational aufgebauten Edit-Schema mittels SQL-Queries "flachgewalzt" und ins Pub-Schema kopiert. Die Schema-Struktur wird automatisch mittels _ili2pg_ aus Edit- und Pub-Modell generiert.
...
- den Beipackzettel (im Unterordner _meta_) zu erstellen/beziehen
