...
Das "gretlEnvironmement"-Property wird verwendet, um zu entscheiden in welche Geocat-Umgebung die Daten hochgeladen werden. Alles ausser `production` landet in der Geocat-Testumgebung. Und die "files"- und "data"-URL, die in der XTF- und HTML-Datei ("Datenblatt") landen werden darüber gesteuert.
